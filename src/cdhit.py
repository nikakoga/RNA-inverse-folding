...
ODSIEWAMY WYLACZNIE PULE NATURALNA. Cel odsiewania to niedopuszczenie, by ta sama sekwencja trafila
naraz do treningu i do testu — a Eterny nie ma w treningu w ogole, wiec odsiewanie jej przeciwko
samej sobie tylko uszczupliloby zbior testowy. Eterne przygotowuje src/prepare.py.

WYMAGANIA. cd-hit-est jest napisany w C++ i nie ma wersji dla Windows; uruchamiamy go przez WSL.
Instalacja opisana w README. Nie ma sciezki zastepczej — bez narzedzia skrypt sie zatrzymuje.
